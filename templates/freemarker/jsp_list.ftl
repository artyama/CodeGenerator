...
<html lang="en">
	...
	<body>
		...
		<div class="col-xs-12">
			<div class="col-sm-6">
				<form id="${table.tableAlias}BaseForm" class="form-inline" method="POST" onsubmit="return false;">
				...
				<table id="${table.tableAlias}BaseTable" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th style="width:10%" class="center">${column.remarks}</th>
							</#list>
			...
			<div class="col-sm-6">
				<div class="widget-box">
					<div class="widget-header">
						<h4 id="${table.tableAlias}Tile">编辑区域</h4>
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								<form id="${table.tableAlias}Form" method="POST" class="form-horizontal" onsubmit="return false;">
									<input type="hidden" name="pId" value="0">
									<input type="hidden" name="type" value="click">
									<input type="hidden" name="keyId" value="">
									<#list table.primaryKeys as key>
									<input type="hidden" name="${key.javaProperty}" value="">
									</#list>
									<#list table.baseColumns as column>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right">
											<font color="red">*</font>${column.remarks}：
										</label>
										<div class="col-sm-9">
											<input type="text" jyValidate="required" name="${column.javaProperty}" maxlength="30" class="col-xs-10 col-sm-5">
										</div>
									</div>
									</#list>
									<div class="center">
		...
		<script src="${jypath}/static/js/mellower/${table.tableAlias}/${table.tableAlias}.js"></script>
	</body>
